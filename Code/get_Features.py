...
def save_results(f1, f1_w, f1_s1, f1_s2, f1_sws, f1_r, w, r, l, f,t):
    ...
    df = pd.read_csv("results_MCM.csv")
    f1= np.mean(f1)
    ...
    df.to_csv("results_MCM.csv", index=False)
            ...
            for l in level:
                for f in n_features:
                    ...
                    #preparamos archivo csv para almacenar datos
                        ...
                        train(w, r, l, f,t, epochs.copy(),test_epochs)
