...
Sj_wake_by_group = {
  "G1_start": [30000,25000,21000,18000,21000,22000,25000,27000,23000,31000,37000,31000,27000,24000,27000,26000,23000,25000,23000,26000,22000,25000,27000,35000,28000,32000,28000,24000,28000,26000,31000,21000,31000,28000,10000,26000,30000,34000,38000],
  "G1_end": [54000,58000,53000,53000,51000,51000,51000,53000,60000,67000,57000,69000,51000,55000,55000,56000,56000,56000,57000,59000,54000,57000,54000,58000,59000,61000,58000,54000,56000,54000,61000,55000,60000,57000,61000,54000,56000,79000,75000],
  "G2_start":0,
  "G2_end":0,
  "G3_start":0,
  "G3_end":0,
...
def crop_epochs(epochs):
    labels = epochs.events[:, -1]
    s1 = str(labels).index('2')
    s2 = str(labels).index('3')
    sws = str(labels).index('4')
    print('index: ' ,s1,s2,sws)
...
def get_epochs(path_psg, path_hypno,name,pos):
    ...
    epochs_train = mne.Epochs(raw=raw_train, events=events_train, event_id=event_id,picks='EEG Fpz-Cz', tmax=tmax, baseline=None,preload=True)
    print('sujeto: ', name, epochs_train)
    #epochs = crop_epochs(epochs_train)
    return epochs_train
...
result, subjets = get_eeg_data(0,25)
#print(len(result))
#print(subjets)
#print(result[20])
